...
Conditionally rendering certain data based on URL matches.

2. How would you explain form validation to someone who has never programmed before?

We don't want to be sending incomplete, wrong, or unsecure data to a database.

3. In 1-2 sentences, define end to end testing.

Tests entire UI expierence.
